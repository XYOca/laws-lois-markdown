...
- c) dans la province du Manitoba, 0,016190 $;
...
(2) Tout producteur, négociant ou couvoirier d’une province non-signataire paie une redevance de 0,018807 $ pour chaque œuf d’incubation de poulet de chair produit dans une province non-signataire qu’il commercialise sur le marché interprovincial à destination d’une province signataire.

(3) Les paragraphes (1) et (2) cessent d’avoir effet le 23 juin 2027.
