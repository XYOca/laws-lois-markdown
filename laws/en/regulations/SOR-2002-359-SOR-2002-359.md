...
- (b) include a statement that
  - (i) the information and documents provided in the application are correct and complete to the best of the knowledge of the signatory,
  - (ii) the signatory has the authority to bind the applicant, and
...
A licensed dealer must take all reasonable measures to ensure that their employees do not contribute to the risk of a precursor being diverted to an illicit market or use.
