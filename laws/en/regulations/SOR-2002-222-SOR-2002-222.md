...
Paragraph 4(1)(c) does not apply in the case where the effluent is determined to be acutely lethal in accordance with the procedures set out in section 5 or 6 of Reference Method STB 1/RM/60 when the owner or operator of a mine is testing at the frequency prescribed in subsection 14(1) or 15(1), unless the effluent is determined to be acutely lethal in accordance with any other acute lethality test.
...
- (a) any final discharge point that is identified by an inspector or fishery officer and that was not identified as required by section 9, within 30 days after the discharge point is identified; and
...
- (a) notify the Minister of the Environment, in writing, at least 30 days before doing so;
...
- (g) the results of any effluent characterization conducted under subsection 15(1).
...
Any report or information that is required to be provided to the Minister of the Environment under these Regulations shall be submitted electronically in the format provided by the Department of the Environment, but the report or information shall be submitted in writing if
...
(1) The owner or operator of a mine shall notify an inspector, fishery officer or authority prescribed by any regulations made under the Act without delay if the results of the effluent monitoring tests conducted under section 12 or 13, subsection 14(1) or section 15 or 16 indicate that
...
- (b) the owner or operator of a mine notifies an inspector, fishery officer or authority prescribed by any regulations made under the Act of the circumstances without delay and indicates when they expect to be able to collect the samples.
...
**effect on the benthic invertebrate community** means a statistical difference between data relating to the indicators referred to in subparagraph 12(1)(e)(ii) and paragraph 12(1)(f) from a study respecting the benthic invertebrate community conducted in
...
- (b) *Short-term Methods for Estimating the Chronic Toxicity of Effluents and Receiving Waters to Marine and Estuarine Organisms* (Reference Method EPA/821/R-02/014), published by the U.S. Environmental Protection Agency;

- (c) *Short-term Methods for Estimating the Chronic Toxicity of Effluent and Receiving Waters to West Coast Marine and Estuarine Organisms* (Reference Method EPA/600/R-95-136), published by the U.S. Environmental Protection Agency; and

- (d) *Canadian add-on procedure to ISO 10710: Test for determining growth inhibition using the macroalgae, Ceramium tenuicorne* (Report STB 1/RM/63), published by the Department of the Environment.
...
- (d) recording the concentration of the deleterious substances prescribed in section 3 of these Regulations, but
  - (i) not recording the concentrations of cyanide if cyanide has never been used as a process reagent at the mine, and
...
- (a) a study respecting the fish population, if the highest concentration of effluent in an exposure area, during a period in which there are deposits, is greater than 1% at any location that is 250 m from a point at which the effluent enters the area from a final discharge point, unless the results of the previous two biological monitoring studies indicate
...
- (b) a study respecting the benthic invertebrate community, if the highest concentration of effluent in an exposure area, during a period in which there are deposits, is greater than 1% at any location that is 100 m from a point at which the effluent enters the area from a final discharge point, unless the results of the previous two biological monitoring studies indicate
...
- (c) a study respecting fish tissue mercury, if
  ...
  - (ii) the method detection limit used in respect of mercury for the analysis of at least two effluent samples in a calendar year is equal to or greater than 0.10 µg/L;
...
- (d) a study respecting fish tissue selenium, if
  ...
  - (iii) the method detection limit used in respect of selenium for the analysis of any effluent sample is equal to or greater than 10 µg/L, or the method detection limit used in respect of selenium for the analysis of at least two effluent samples in a calendar year is equal to or greater than 5 µg/L; and
...
- (h) a determination as to whether there is a statistically significant difference between the sampling areas for the calculations under subparagraphs (e)(i) to (iii) and paragraph (f), taking into consideration the sex of the fish where applicable, with the statistical comparison made separately and independently for each effect indicator;

- (i) a statistical analysis of the results of the calculations under subparagraphs (e)(i) to (iii) that indicates the probability of correctly detecting an effect of a predefined size and the degree of confidence that can be placed in the calculations;
