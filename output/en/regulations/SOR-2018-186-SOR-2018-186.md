...
instrument_number: "SOR/2018-186"
language: "en"
type: "regulation"
---
...
(1) A sticker, film or other similar material that can be removed, or a surface coating material, that is applied to an accessible part of a playpen or accessory must not contain, when it is tested in accordance with a method that conforms to good laboratory practices,
...
### 6 Parts — textile or other pliable material
...
### 11 Parts — wood, plastic or similar hard material
...
### 14 Cords and straps — length — general
...
### 15 Cords and straps — loops — general
...
### 21 Rigid top rails — folding playpen
...
### 23 Top rails affixed to brackets
...
### 24 Latching or locking mechanisms — folding playpens
...
### 25 Latching or locking mechanisms — operation
...
### 26 Appearance of latching or locking — top rails
...
### 29 Vertical displacement — removable floor pad with panel
...
### 30 Entrapment — accessory placed on or fixed to playpen
...
### 31 Structural integrity — sleep and change table accessories
...
### 33 Sleep accessories that rock or swing — angle
...
### 34 Sleep accessories — height of sides
...
### 35 Sleep accessories — restraint systems
...
### 36 Reference to *Canada Consumer Product Safety Act* or Regulations
...
### 43 Exception — Pouches

Despite paragraph 38(b), the information that is required by section 42 may be contained in or on a pouch that is permanently affixed to the playpen or accessory if the relevant warnings set out in sections 44 to 49 are provided with that information.

### Additional Requirements for Playpens

### 44 Warning — all playpens

The following warning or its equivalent must appear on every playpen:
...
### 45 Warning — folding playpens

The following warning or its equivalent must appear on every folding playpen, immediately after the warning required by section 44:
...
### 46 Warning — accessories

The following warning or its equivalent must appear on every accessory:
...
### 47 Warning — accessories — occupant retention area

The following warning or its equivalent must appear on every accessory that extends over or into the occupant retention area, immediately after the warning required by section 46:
...
### 48 Warning — accessories other than sleep accessories

The following warning or its equivalent must appear on every accessory other than a sleep accessory, immediately after the warnings required by sections 46 and 47:
...
The *Playpens Regulations*[^] are repealed.

## Coming into Force

### [^]51 Six months after publication
...
> Her Excellency the Governor General in Council, on the recommendation of the Minister of Health, pursuant to section 37[^] of the *Canada Consumer Product Safety Act*[^], makes the annexed *Playpens Regulations*.



## SCHEDULE 1  Test for Strength of Parts Made of a Textile or Other Pliable Material that are Permanently Affixed to a Rigid Structural Component

(Section 6)

### 1

The following method is to be used for testing the strength of playpen or accessory parts that are made of a textile or other pliable material and that are permanently affixed to a rigid structural component of the product:
...
## SCHEDULE 2  Test for Strength of Mesh and Integrity of Attachment

(Subsection 7(1))

### 1

The following method is to be used for testing the strength of mesh on a playpen or accessory and the integrity of its attachment to that product:
...
## SCHEDULE 3  Test for Determination of Mesh Size

(Subsection 7(2))

### 1

The following method is to be used for testing the size of openings in mesh on a playpen or accessory:
...
## SCHEDULE 4  Test for Openings

(Section 10)

### 1

The following method is to be used for testing completely bounded openings that are formed or exposed in the surfaces that define the occupant retention area of a playpen or sleep accessory:
...
## SCHEDULE 5  Small Parts Cylinder
...
The following method is to be used for testing a loop that is formed by a cord, strap or other similar item of a playpen or sleep accessory:
...
The following method is to be used for testing a cord, strap or other similar item of a change table accessory that is designed to restrain a child:
...
## SCHEDULE 7  Test for Stability

(Section 17)

### 1

The following method is to be used for testing the stability of a playpen:
...
## SCHEDULE 8  Tests for Deflection and Strength of Sides

(Sections 19 and 20)

### 1

The following method is to be used for testing the deflection of a playpen’s sides:
...
The following method is to be used for testing the strength of a side of a playpen that has a hinge:
...
## SCHEDULE 9  Tests for Top Rail Configuration

(Sections 21 and 22)

### 1

The following method is to be used for testing the space created when a rigid top rail of a folding playpen is folded:
...
The following method is to be used for testing the V-shaped space created by the unlatching or unlocking of only one of the hinges of a rigid top rail of a playpen:
...
The following method is to be used for testing the space created when a non-rigid top rail of a playpen is folded:
...
|  | Column 1 | Column 2 |
| Item | Surface or point of template | Surface or point of template |
| --- | --- | --- |
| 1 | B1 | B2 |
| 2 | C1 | C2 |
| 3 | C1 | D |
...
## SCHEDULE 10  Test for Top Rails Affixed to Brackets

(Section 23)

### 1

The following method is to be used for testing the top rail of a playpen that is affixed to brackets that are located above a post:

- (a) assemble the playpen according to the manufacturer’s instructions, omitting any attachments that could interfere with the conduct of the test;

- (b) secure the playpen by using any blocking or support that does not interfere with the conduct of the test;

- (c) mount at the centre of a top rail a rigid moment arm that has a mass of less than 2.2 kg, has a length of at least 610 mm and has two clamping surfaces — each having a surface area that is a minimum of 6.5 cm^2^ and a maximum of 26 cm^2^ — in such a way that it extends horizontally towards the exterior of the playpen;
...
## SCHEDULE 11  Test for Latching or Locking Mechanisms

(Section 26)

### 1

The following method is to be used for testing the latching or locking mechanism of a top rail of a playpen:
...
## SCHEDULE 12  Test for Entanglement

(Section 27)

### 1

The following method is to be used for determining whether a mechanism, fastener or projection of a playpen that is accessible to the child poses an entanglement hazard:
...
## SCHEDULE 13  Tests for Structural Integrity

(Section 28)

### 1

The following method is to be used for testing the structural integrity of the playing surface of a playpen, of any component of the playpen that is located below the playing surface and of the playpen’s rigid structural components under static conditions:
...
The following method is to be used for testing the structural integrity of the playing surface of a playpen, of any component of the playpen that is located below the playing surface and of the playpen’s rigid structural components under dynamic conditions:
...
## SCHEDULE 14  Tests for Vertical Displacement of Removable Floor Pad and Removable and Foldable Component

(Section 29)

### 1

The following method is to be used for testing the vertical displacement of a removable floor pad of a playpen that is composed of a rigid panel or a series of rigid panels:
...
The following method is to be used for testing the vertical displacement of a removable and foldable component of a playpen that is composed of a rigid panel or a series of rigid panels and on which a removable floor pad rests:
...
## SCHEDULE 15  Tests for Entrapment in Accessories

(Subsections 30(1) and (2))

### 1

The following method is to be used for testing openings that are created when an accessory is placed on or fixed to a playpen:
...
The following method is to be used for testing openings that are created by the detachment or displacement of an accessory from a playpen:
...
## SCHEDULE 16  Test for Angle of Foldable Mattress Pad of Sleep Accessories

(Subsection 32(2))

### 1

The following method is to be used for testing the angle of the surfaces adjacent to a fold in a foldable mattress pad that is supplied with, or that is designed or advertised to be used with, a sleep accessory:
...
## SCHEDULE 17  Standard Sans-serif Type
